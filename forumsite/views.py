...
def post_detail(request, year, month, day, post):
  ...
  return render(request,'forumsite/post/detail.html',{'post':post,'comments':comments,'form':form,'similar_posts':similar_posts})
...
def post_search(request):
  ...
  return render(request,'forumsite/post/search.html',{'form':form,'query':query,'results':results})